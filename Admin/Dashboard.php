...
<div class="quick-variable-dashboard">
        ...
        <div id="quickAuthenticateWrapper">
            ...
            <div>
                <div class="quick-selections" style="display: flex; gap: 10%; align-items: center">
                    <h4><?php echo wp_kses('Variation Gallery On: ','product-variation-table-with-quick-cart');
                        if(empty($license_active)){
                            echo "(Pro)";
                        }
                        ?></h4>
                ...
                <div class="quick-selections quick-selections-style">
                    <h4><?php echo wp_kses('Gallery Image Size: ','product-variation-table-with-quick-cart');
                        if(empty($license_active)){
                            echo "(Pro)";
                        }
                        ?></h4>
                ...
                <div class="quick-selections">
                    <div class="quick-selectors-wrapper m-top">
                        <label for="gallery-navigation-button-icon-color"><strong> <?php echo wp_kses('Gallery Navigation Button Icon Color: ','product-variation-table-with-quick-cart');
                ...
                <div class="quick-selections">
                    <div class="quick-selectors-wrapper m-top">
                        <label for="gallery-navigation-button-icon-hover-color"><strong> <?php echo wp_kses('Gallery Navigation Button Icon Hover Color: ','product-variation-table-with-quick-cart');
                ...
                <div class="quick-selections">
                    <div class="quick-selectors-wrapper m-top">
                        <label for="gallery-navigation-button-background-color"><strong> <?php echo wp_kses('Gallery Navigation Button Background Color: ','product-variation-table-with-quick-cart');
                ...
                <div class="quick-selections">
                    <div class="quick-selectors-wrapper m-top">
                        <label for="gallery-navigation-button-background-hover-color"><strong> <?php echo wp_kses('Gallery Navigation Button Background Hover Color: ','product-variation-table-with-quick-cart');
    ...
    <div id="attribute-gallery" class="tabcontent" style="">
        ...
        <div id="quickAuthenticateWrapper">
            ...
            <div>
                <div class="quick-selections" style="display: flex; gap: 10%; align-items: center">
                    <h4><?php echo wp_kses('Attribute Gallery On: ','product-variation-table-with-quick-cart');
                        if(empty($license_active)){
                            echo "(Pro)";
                        }
                        ?></h4>
                    <div class="quick-selectors-wrapper">
                        <div class="attribute-gallery-on-off">
                            <label class="switch">
                                <input type="checkbox" id="attribute-gallery-on-off" name="attribute-gallery-on-off" <?php if( $attributeGalleryOnOff == "true" ): echo esc_attr("checked"); endif; ?>>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>
                ...
                <!-- Gallery Image Size -->
                <div class="quick-selections quick-selections-style">
                    <h4><?php echo wp_kses('Attribute Gallery Image Size: ','product-variation-table-with-quick-cart');
                        if(empty($license_active)){
                            echo "(Pro)";
                        }
                        ?></h4>
    ...
    <div id="select-variation-ul-li" class="tabcontent">
        ...
        <div style="display: flex; gap: 30%">
                ...
                <div id="quickAuthenticateWrapper">
                    <div>
                        <div class="quick-selections" style="display: flex; gap: 23.8%; align-items: center">
                            <h4><?php echo wp_kses('Variation List Enable: ','product-variation-table-with-quick-cart');
                                if(empty($license_active)){
                                    echo "(Pro)";
                                }
                                ?></h4>
                        ...
                        <!-- List Image Size -->
                        <div class="quick-selections quick-selections-style">
                            <h4><?php echo wp_kses('List Image Size: ','product-variation-table-with-quick-cart');
                                if(empty($license_active)){
                                    echo "(Pro)";
                                }
                                ?></h4>
                        ...
                        <h3 style="color: red; margin-top: 20px;"><?php echo wp_kses('Variation list is enable, variation swatches ','product-variation-table-with-quick-cart'); ?>
                            <br><?php echo wp_kses('will not work in single product page ','product-variation-table-with-quick-cart'); ?></br>
                        </h3>

                        <div class="quick-selections quick-selections-style" style="display: flex; gap: 50%">

                            <div>
                                <h4><?php echo wp_kses('Variation List Template: ','product-variation-table-with-quick-cart');
                                    if(empty($license_active)){
                                        echo "(Pro)";
                                    }
                                    ?></h4>
                                ...
                                <div >
                                    <select id="select-design-list" class="variation-list-template" style="outline: none">
                                        <option value="template_1" <?php selected($variationListTemplate, 'template_1'); ?>><?php echo wp_kses('Template 1','product-variation-table-with-quick-cart');?></option>
                                        <option value="template_2" <?php selected($variationListTemplate, 'template_2'); ?>><?php echo wp_kses('Template 2','product-variation-table-with-quick-cart');?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="quick-selections">
                            <div class="quick-selectors-wrapper m-top">
                                <label for="list-pagination"><strong> <?php echo wp_kses('Items Per Pages: ','product-variation-table-with-quick-cart');
                                        if(empty($license_active)){
                                            echo "(Pro)";
                                        }
                                        ?></strong></label>
                                <input id="list-pagination" class="list-pagination" type="number" min="1" name="list-pagination" value="<?php echo esc_attr( $listPagination ); ?>"  >
                            </div>
                        </div>

                        <div class="quick-selections" style="display: flex; gap: 40%; align-items: center">
                            <h4><?php echo wp_kses('Show Label: ','product-variation-table-with-quick-cart');
                                if(empty($license_active)){
                                    echo "(Pro)";
                                }
                                ?></h4>
                        ...
                        <div class="quick-selections" style="display: flex; gap: 17%; align-items: center">
                            <h4><?php echo wp_kses('Show Discount Badge: ','product-variation-table-with-quick-cart');
                                if(empty($license_active)){
                                    echo "(Pro)";
                                }
                                ?>
                        ...
                        <div id="badge-all-settings" style="">
                            <div class="quick-selections" style="display: flex; gap: 15%; align-items: center">
                                <h4><?php echo wp_kses('Show Badge at Right Side: ','product-variation-table-with-quick-cart');
                                    if(empty($license_active)){
                                        echo "(Pro)";
                                    }
                                    ?></h4>
                            ...
                            <div class="quick-selections" style="display: flex; gap: 13%; align-items: center">
                                <h4><?php echo wp_kses('Show Discount Price as Flat: ','product-variation-table-with-quick-cart');
                                    if(empty($license_active)){
                                        echo "(Pro)";
                                    }
                                    ?></h4>
                            ...
                            <div class="quick-selections">
                                <div class="quick-selectors-wrapper m-top">
                                    <label for="list-for-percent"><strong> <?php echo wp_kses('For Percent Label: ','product-variation-table-with-quick-cart');
                                            if(empty($license_active)){
                                                echo "(Pro)";
                                            }
                                            ?></strong></label>
                            ...
                            <div class="quick-selections">
                                <div class="quick-selectors-wrapper m-top">
                                    <label for="list-for-flat"><strong> <?php echo wp_kses('For Flat Label: ','product-variation-table-with-quick-cart');
                                            if(empty($license_active)){
                                                echo "(Pro)";
                                            }
                                            ?></strong></label>
                            ...
                            <div class="quick-selections">
                                <div class="quick-selectors-wrapper">
                                    <label for="list-badge-bg-color"><strong> <?php echo wp_kses('Badge Background Color: ','product-variation-table-with-quick-cart');
                                            if(empty($license_active)){
                                                echo "(Pro)";
                                            }
                                            ?></strong></label>
                            ...
                            <div class="quick-selections">
                                <div class="quick-selectors-wrapper">
                                    <label for="list-badge-text-color"><strong> <?php echo wp_kses('Badge Text Color: ','product-variation-table-with-quick-cart');
                                            if(empty($license_active)){
                                                echo "(Pro)";
                                            }
                                            ?></strong></label>
                            ...
                            <div class="quick-selections">
                                <div class="quick-selectors-wrapper m-top">
                                    <label for="list-badge-height"><strong> <?php echo wp_kses('Badge Height (px): ','product-variation-table-with-quick-cart');
                                            if(empty($license_active)){
                                                echo "(Pro)";
                                            }
                                            ?></strong></label>
                            ...
                            <div class="quick-selections">
                                <div class="quick-selectors-wrapper m-top">
                                    <label for="list-badge-width"><strong> <?php echo wp_kses('Badge Width (px): ','product-variation-table-with-quick-cart');
                                            if(empty($license_active)){
                                                echo "(Pro)";
                                            }
                                            ?></strong></label>
            ...
            <div style="display: flex; align-items: end; position: absolute; left: 600px">
