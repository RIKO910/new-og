jQuery(document).ready(function () {
  ...
  jQuery(".quick-slide-variable").each(function () {
    ...
    function quickVariableDetails($element) {
      ...
      // jQuery("#quick-add-to-cart-shop-page").attr("data-variationId", variationData.variationId);
      const variationId = variationData.variationId; // Fetch the variation ID
      const variationURL = variationData.variationURL; // Fetch the variation ID
      ...
      //   }
      //
      //   const label = ucfirst(key.replace('pa_', ''));
      //
  ...
  jQuery(document).ready(function($) {
    $('.quick-add-to-cart-shop-page').on('click', function(e) {
      ...
      if (!variationId || variationId === "") {
        ...
        return; // Prevent adding to cart if no valid variation
      }
  ...
  jQuery(document).ready(function ($) {
    $(".bulk-add-to-cart").on("click", function (e) {
      ...
      if (!button.hasClass('loading')) {
        ...
        button.find("i.fa-cart-plus").remove();
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (popupContentDiv) {
    ...
    // Dynamically set height and width based on your condition
    let popUPImageShow = 'default'; // Example value, replace with your dynamic condition
    let imagePopupHeight = 500;    // Replace with the actual logic for height
    let imagePopupWidth = '100%';  // Replace with the actual logic for width
    ...
    console.log('Image element dynamically added to popup-content:', imgElement);
  } else {
