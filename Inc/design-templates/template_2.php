...
<div id="mobile-quick-variable-table">
    ...
    foreach ($variations as $var) {
        ...
        ?>
        <div class="mobile-variation-card-row">
            ...
            <div  class="">
                ...
                <?php if ($skuHideShow === "true"){
                    ?>
                    <div style="text-overflow: ellipsis; overflow: hidden;   white-space: nowrap;  width: 80px;  "><?php echo esc_html($variation->get_sku()); ?></div>
                    <?php
                }?>
