...
$variableSettings        = get_option("quick_variable_all_checked", []);
        ...
        if ($nameImageRedirect === "true"){
            ...
            <a href="#" class="dynamic-variation-url" target="_blank">
                <div src="<?php echo esc_url($variableDetailsImage); ?>"
                     ...
                     style="width: 100%; height: 250px; <?php if (empty($variableDetailsImage)) { echo 'display:none;'; } ?>"
        ...
        <div id="quick-product-content">
            ...
            <?php if (!empty($variableSKU) && !empty($variableSettings)) { ?>
                ...
                <div style="display: flex; gap: 4px; justify-content: center">
                    <strong><?php  echo esc_html("SKU:", "wc-quick-cart-and-table-for-variation") ?> </strong>
                    <p class="variable-sku <?php if (empty($variableSKU) && !empty($variableSettings)) { echo esc_attr("quick-hidden"); } ?>"></p>
                </div>

            <?php } ?>

            <p><strong><?php echo esc_html("Price:", "wc-quick-cart-and-table-for-variation"); ?> </strong><span id="variable-product-price"></span></p>
            <div id="variable-product-variations"></div>
        </div>

        <!-- Quantity and Add-to-Cart Button -->
        <div class="quick-quantity-container">
            <button class="quick-quantity-decrease" id="decrease"><?php echo esc_html("-", "wc-quick-cart-and-table-for-variation"); ?></button>
            <input type="text" autocomplete="off" id="quantity" class="quick-quantity-input" value="1" data-max="">
            <button class="quick-quantity-increase" id="increase"><?php echo esc_html("+", "wc-quick-cart-and-table-for-variation"); ?></button>
